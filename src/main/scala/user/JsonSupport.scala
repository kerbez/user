...
//  implicit val updateNikName = jsonFormat3(UpdateNikName)
//  implicit val resendEmailCode = jsonFormat1(ResendEmailCode)
//
...
//  implicit val codeSentFormat = jsonFormat2(CodeSent)
